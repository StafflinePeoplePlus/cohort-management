...
export type ResolversTypes = {
	...
	CohortMemberInviteResult: ResolverTypeWrapper<
		ResolversUnionTypes<ResolversTypes>['CohortMemberInviteResult']
	>;
...
export type CohortInviteMemberErrorResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['CohortInviteMemberError'] = ResolversParentTypes['CohortInviteMemberError']
> = {
...
export type CohortMemberInviteResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['CohortMemberInvite'] = ResolversParentTypes['CohortMemberInvite']
> = {
	inviteID?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CohortMemberInviteResultResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['CohortMemberInviteResult'] = ResolversParentTypes['CohortMemberInviteResult']
> = {
	__resolveType: TypeResolveFn<
		'CohortInviteMemberError' | 'CohortMemberInvite',
		ParentType,
		ContextType
	>;
};

export type CohortMemberMetadataInputResolvers<
	ContextType = any,
	ParentType extends
		ResolversParentTypes['CohortMemberMetadataInput'] = ResolversParentTypes['CohortMemberMetadataInput']
> = {
...
> = {
	cohortInviteMember?: Resolver<
		ResolversTypes['CohortMemberInviteResult'],
		ParentType,
		ContextType,
		RequireFields<MutationCohortInviteMemberArgs, 'input'>
	>;
};
